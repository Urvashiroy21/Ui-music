...
import {StyleSheet, Switch, Text, Platform, Linking, View} from 'react-native';
...
export default SettingsTab = () => {
  ...
  const [transmitLanguage, setTransmitLanguage] = useState(
  ...
  const openRepo = () => {
    const url = 'https://github.com/Urvashiroy21';
